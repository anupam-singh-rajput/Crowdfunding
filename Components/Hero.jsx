            ...
            <div className="flex flex-col items-center justify-between xl:flex-row">
              <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                  BlockChain Based <br className="hidden md:block" />
                  Crowd Funding 
                </h2>
                <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                  Blockchain-based crowdfunding, known as ICOs or Token Sales, enables projects to raise funds directly from a global pool of investors using digital tokens issued on a blockchain. It offers decentralization, global accessibility, and liquidity but entails risks such as regulatory uncertainty and fraud.
                </p>
                {/* <a
                  href="/"
                  aria-label=""
                ...
                <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                  ...
                  <form>
                    ...
                    {/* <div className="mb-1 sm:mb-2">
                      ...
                      <input
                      onChange={handleImageUrlChange} // Corrected syntax
